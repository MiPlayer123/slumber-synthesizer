...
import { Mesh, Vector3, CubicBezierCurve3, Group } from "@/node_modules/@types/three"
...
function GlobeObject({ dreamData, onDreamSelect }: { dreamData: DreamItem[], onDreamSelect: (dream: DreamItem) => void }) {
