...
import { Brain, Star, Hash, Sparkles, ChevronRight, BarChart3, HeartPulse } from "lucide-react"
        ...
        <div className="relative z-10 p-6 md:p-8">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold bg-gradient-to-r from-white to-white/80 text-transparent bg-clip-text">Dream Analysis</h2>
            </div>
          ...
          {activeTab === "analysis" && (
            ...
            >
              <div className="p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/5 shadow-inner">
                <p className="text-white/90 leading-relaxed">{dreamAnalysis.summary}</p>
              </div>
                  ...
                  {dreamAnalysis.themes.map((theme, i) => (
                    ...
                    >
                      <div className="flex justify-between items-center mb-2">
                        <span className="font-medium text-white/90 group-hover:text-white transition-colors">#{theme.name}</span>
                        <div className="flex">
                  ...
                  {dreamAnalysis.symbols.map((symbol, i) => (
                    ...
                    >
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="font-medium text-lg text-white">{symbol.name}</span>
                      </div>
                      <p className="text-sm text-white/80 ml-9">{symbol.description}</p>
                    </motion.div>
                  ))}
                </div>
              </div>
                  ...
                  {dreamAnalysis.emotions.map((emotion, i) => (
                    ...
                    >
                      <div className="flex justify-between text-sm items-center">
                        ...
                        <span className="text-white/70 font-mono bg-white/5 px-2 py-0.5 rounded">{emotion.intensity}%</span>
                      </div>
              ...
              >
                ...
                <div className="pl-8">
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10">
                    <a href="#" className="text-cyan-400 flex items-center gap-2 hover:text-cyan-300 transition-colors group">
