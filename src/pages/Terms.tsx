      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="space-y-8 text-purple-100">
          <section>
            ...
            <p className="mb-3">
              By accessing or using Rem, you agree to be bound by these Terms of
          ...
          <section>
            ...
            <p className="mb-3">
              Rem is a dream journaling and analysis platform that allows users
              to record, analyze, and optionally share their dreams. Our service
              includes AI-powered dream analysis, image generation, and
              community features.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              terms or remain inactive for extended periods.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              Our service allows you to post, store, and share content ("User
              Content"). You retain ownership of your User Content, but you
              grant us a license to use it for operating, improving, and
              promoting our service.
            </p>
            <p className="mb-3">
              When you share dreams publicly, you grant other users permission
              to view your content. You can control privacy settings for your
              dreams.
            </p>
            <p>
              You are solely responsible for your User Content and the
              consequences of sharing it. We reserve the right to remove content
          ...
          <section>
            ...
            <p className="mb-3">
              Our service uses AI to analyze dreams and generate content such as
              interpretations and images. This AI-generated content is provided
              "as is" without warranty of any kind. AI analysis should not be
              considered professional advice and is for entertainment purposes
              only.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              To the maximum extent permitted by law, Rem shall not be liable
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              our website or through the service. Your continued use of the
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              through our feedback form accessible via the Support link.
            </p>
          </section>
        </div>
