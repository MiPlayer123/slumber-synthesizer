      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="space-y-8 text-purple-100">
          <section>
            ...
            <p className="mb-3">
              At Rem, we value your privacy and are committed to protecting your
              personal information. This Privacy Policy explains how we collect,
              use, disclose, and safeguard your information when you use our
              dream journaling and analysis service.
            </p>
            <p>
              By using Rem, you agree to the collection and use of information
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                ...
                entries, descriptions, emotions, and categories you provide.
              </li>
              <li>
                <span className="font-medium">Usage Data:</span> Information on
                how you access and use our service.
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              If you wish to delete your account entirely, please contact us and
          ...
          <section>
            ...
            <p>
              ...
              contact us through our feedback form accessible via the Support
              link.
            </p>
          </section>
        </div>
