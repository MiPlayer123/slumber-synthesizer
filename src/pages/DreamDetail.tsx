  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="bg-card text-card-foreground rounded-lg shadow-md overflow-hidden">
        <div className={`md:grid md:grid-cols-5 flex flex-col ${fromProfile ? 'md:flex-col' : ''}`}>
          <div className={`md:col-span-3 ${fromProfile ? 'md:h-[350px]' : 'h-[350px] md:h-auto'} bg-muted relative`}>
            {dream.image_url ? (
              <img 
                src={dream.image_url} 
                alt={dream.title} 
          ...
          <div className={`md:col-span-2 p-6 flex flex-col ${fromProfile ? 'md:p-4' : ''}`}>
            ...
            <div id="comments" ref={commentsRef} className="mt-2">
              ...
              <div className="mt-4 pt-4 border-t">
                {user ? (
                  <form onSubmit={handlePostComment} className="flex items-center gap-2 pt-0">
