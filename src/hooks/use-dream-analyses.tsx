    ...
    queryFn: async () => {
      ...
      try {
        ...
        if (error && error.code === '42703' && error.message.includes('user_id')) {
          console.log("Attempting alternative query because user_id column may be missing");
          ...
          if (joinError) {
            console.error("Error with alternative dream analyses query:", joinError);
            toast({
              variant: "destructive",
              title: "Database Error",
              description: "Could not load your dream analyses. The database may need to be fixed.",
            });
            ...
            toast({
              ...
              description: "Please run the fix_dream_analyses.sh script from the project root to fix this issue.",
            });
