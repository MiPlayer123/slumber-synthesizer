...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    className={cn(
      ...
      "transition-all duration-300 will-change-opacity transform-gpu",
      "after:absolute after:inset-0 after:content-[''] after:pointer-events-none after:bg-background/5 after:opacity-0",
      className,
    )}
    style={{
  ...
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "before:absolute before:inset-0 before:content-[''] before:bg-background before:z-[-1]",
        className,
      )}
      style={{
