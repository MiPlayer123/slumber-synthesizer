      ...
      <div className="relative z-10 p-8 lg:p-10">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/60 text-sm mt-1">AI-powered insights into your subconscious</p>
            </div>
          </div>
          <motion.div
            whileHover={{ scale: 1.02 }}
            className="bg-gradient-to-r from-purple-500/20 to-cyan-500/20 px-4 py-2 rounded-full text-xs font-medium flex items-center gap-2 backdrop-blur-sm border border-white/10"
          >
            <motion.div
              animate={{ rotate: 360 }}
        ...
        >
          {[
            ...
            { id: "themes", label: "Themes & Symbols", icon: Hash, gradient: "from-indigo-500 to-cyan-500" },
            { id: "emotions", label: "Emotional Landscape", icon: Layers, gradient: "from-blue-500 to-teal-500" }
          ].map((tab) => (
            <motion.button
              key={tab.id}
