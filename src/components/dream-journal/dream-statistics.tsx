    ...
    >
      ...
      <div className="relative z-10 p-8 lg:p-10">
        ...
        >
          <div className="flex items-center gap-4">
            <motion.div
              ...
              className="bg-gradient-to-br from-indigo-500/30 to-blue-500/30 p-3 rounded-2xl backdrop-blur-sm border border-white/10"
            >
              <BarChart3 className="w-7 h-7 text-indigo-300" />
            </motion.div>
            <div>
              <h2 className="text-3xl font-bold bg-gradient-to-r from-white via-indigo-200 to-blue-200 bg-clip-text text-transparent">
                Dream Statistics
              </h2>
              <p className="text-white/60 text-sm mt-1">Track your dream patterns and insights</p>
            </div>
          </div>
          <motion.div
            whileHover={{ scale: 1.02 }}
            className="bg-gradient-to-r from-indigo-500/20 to-blue-500/20 px-4 py-2 rounded-full text-xs font-medium flex items-center gap-2 backdrop-blur-sm border border-white/10"
          >
            <motion.div
              animate={{ rotate: 360 }}
        ...
        <motion.div
          ...
          className="flex gap-2 p-2 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 mb-8"
        >
          {[
            { id: "overview", label: "Overview", icon: Activity, gradient: "from-indigo-500 to-blue-500" },
            { id: "patterns", label: "Patterns & Trends", icon: TrendingUp, gradient: "from-blue-500 to-cyan-500" },
            { id: "themes", label: "Themes & Symbols", icon: Hash, gradient: "from-cyan-500 to-teal-500" },
            { id: "calendar", label: "Calendar View", icon: CalendarDays, gradient: "from-teal-500 to-green-500" }
          ].map((tab) => (
            <motion.button
              key={tab.id}
