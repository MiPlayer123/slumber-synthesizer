    ...
    symbols: [
      {
        ...
        count: 35,
        percentage: 25,
        description: "Rivers, oceans, rain",
      },
      {
        name: "doors",
        count: 28,
        percentage: 20,
        description: "Entrances, exits, passages",
      },
      {
        name: "animals",
        count: 24,
        percentage: 17,
        description: "Dogs, cats, wild animals",
      },
      {
        name: "vehicles",
        count: 19,
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mt-4 sm:mt-6">
                  <div className="bg-purple-500/10 rounded-lg p-3 text-center">
                    <p className="text-lg sm:text-xl font-bold text-purple-300">
                      {Math.max(
                        ...statsData.monthlyDreams.map((d) => d.dreams),
                      )}
                    </p>
                  ...
                  <div className="bg-cyan-500/10 rounded-lg p-3 text-center">
                    <p className="text-lg sm:text-xl font-bold text-cyan-300">
                      {Math.round(
                        statsData.monthlyDreams.reduce(
                          (sum, d) => sum + d.dreams,
                          0,
                        ) / 12,
                      )}
                  ...
                  <div className="bg-teal-500/10 rounded-lg p-3 text-center">
                    <p className="text-lg sm:text-xl font-bold text-teal-300">
                      {statsData.monthlyDreams[
                        statsData.monthlyDreams.length - 1
                      ].dreams -
                        statsData.monthlyDreams[0].dreams >
                      0
                        ? "+"
                        : ""}
                      {statsData.monthlyDreams[
              ...
              >
                ...
                <div className="space-y-2 lg:space-y-3">
                  ...
                  <div className="flex items-center justify-between mb-2 lg:mb-3">
                    <h4 className="text-sm sm:text-base lg:text-lg font-medium text-white/90">
                      December 2024
                    </h4>
                  ...
                  <div className="grid grid-cols-3 gap-2 lg:gap-3 mt-3 lg:mt-4 pt-3 lg:pt-4 border-t border-white/10">
                    <div className="text-center">
                      <p className="text-base lg:text-lg font-bold text-emerald-300">
                        {
                          statsData.calendar.entries.filter((d) => d.dreams > 0)
                            .length
                        }
                      </p>
                    ...
                    <div className="text-center">
                      <p className="text-base lg:text-lg font-bold text-teal-300">
                        {Math.round(
                          (statsData.calendar.entries.filter(
                            (d) => d.dreams > 0,
                          ).length /
                            statsData.calendar.entries.length) *
                            100,
                        )}
                        %
                      </p>
