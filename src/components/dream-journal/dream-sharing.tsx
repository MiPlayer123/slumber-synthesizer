  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-8 lg:p-10">
        ...
        >
          <div className="flex items-center gap-4">
            <motion.div
              ...
              className="bg-gradient-to-br from-cyan-500/30 to-teal-500/30 p-3 rounded-2xl backdrop-blur-sm border border-white/10"
            >
              <Users className="w-7 h-7 text-cyan-300" />
            </motion.div>
            <div>
              <h2 className="text-3xl font-bold bg-gradient-to-r from-white via-cyan-200 to-teal-200 bg-clip-text text-transparent">
                Dream Community
              </h2>
              <p className="text-white/60 text-sm mt-1">Connect with fellow dreamers</p>
            </div>
          </div>
          <motion.div
          ...
          >
            <Button
              size="sm"
              className="bg-gradient-to-r from-cyan-500 to-teal-500 hover:from-cyan-600 hover:to-teal-600 text-white shadow-lg shadow-cyan-500/20 border-0"
            >
        ...
        >
          {[
            { id: "community", label: "Community Dreams", icon: Globe, gradient: "from-cyan-500 to-teal-500" },
            { id: "following", label: "Following", icon: Heart, gradient: "from-teal-500 to-green-500" }
          ].map((tab) => (
            <motion.button
              key={tab.id}
