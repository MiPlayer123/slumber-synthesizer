      ...
      {showExpiredAlert && (
        <Alert variant="destructive" className="max-w-xl mx-auto mb-8">
          ...
          <AlertDescription>
            ...
            these links are only valid for 1 hour. Please request a new password
            reset link using the form below.
          </AlertDescription>
        </Alert>
      )}
      ...
      <Tabs defaultValue="standard" className="max-w-4xl mx-auto">
        ...
        <TabsContent value="advanced" className="py-4">
          <div className="mb-4 text-center text-sm text-gray-600 dark:text-gray-300">
            Use this advanced tool if you have a code from a reset link that
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Check your spam folder. Email providers sometimes filter out
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Password reset links expire after 1 hour. Request a new reset
              email if needed.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Password reset links can only be used once. If you see an error
              about "code challenge", this means the link was already used or
              your browser data was cleared. Request a new link.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              If you're reaching the reset form but the new password isn't
              saving, try the "Advanced Reset" tool above. This directly
              processes the code from your reset link.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Contact support at support@slumber-synthesizer.com or try creating
              a new account.
            </p>
          </div>
          ...
          <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            ...
            <p className="text-sm text-blue-600 dark:text-blue-200 mt-1">
              If you received a reset link but it doesn't work, you can analyze
              the link with our debug tool.
            </p>
            <p className="text-sm mt-2">
              ...
              >
                Open Password Reset Link Debugger{" "}
                <ArrowRight className="ml-1 h-3 w-3" />
              </a>
            </p>
            <p className="text-xs text-blue-500 dark:text-blue-400 mt-1">
              Note: When clicked from your email, copy the entire URL from your
              browser and paste it after navigating to the debugger.
            </p>
          </div>
        </div>
      </div>
